...
Original file is located at
    https://colab.research.google.com/drive/1yEDSY7buvdOXQZMwNYdh9xD7Eb5PODr6
"""
...
class GameState:
    ...
    def __lt__(self, other): #Override of heap "<" operator compare real costs
        return self.cost < other.cost
...
def ucs(grid): #Main UCS function
...
Result, total_distance, total_expanded_nodes = ucs(grid)
